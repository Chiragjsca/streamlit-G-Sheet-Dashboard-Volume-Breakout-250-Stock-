...
# ── ULTRA HD CHART STYLING & RENDERING ─────────────────────
                        ...
                        if _sankey_sales is not None and _sankey_profit is not None and 0 < _sankey_profit < _sankey_sales:
                            ...
                            fig_sankey = go.Figure(go.Sankey(
                                arrangement="snap",
                                textfont=dict(color="#c62828", size=13, family="Arial Black, Arial, sans-serif"),
                                node=dict(
                                    pad=30, thickness=18,
                        ...
                        if len(_cs_valid) >= 2:
                            ...
                            st.caption("Equity Capital + Reserves + Total Debt, from the Fundamentals data above.")
                        else:
                            st.info("Not enough of Total Equity Capital / Reserves / Total Debt available to build a Capital Structure flow.")
                        ...
                        if prev_close and last_close is not None:
                            ...
                            fig_wf = go.Figure(go.Waterfall(
                                ...
                                textfont=dict(color="#c62828", size=13),
                        ...
                        if last_rsi14 is not None:
                            fig_rsi_gauge = go.Figure(go.Indicator(
                                ...
                                number=dict(font=dict(color="#c62828", size=28)),
                        ...
                        if _wk52_high and _wk52_low is not None and _wk52_high > _wk52_low and last_close is not None:
                            ...
                            fig_range_gauge = go.Figure(go.Indicator(
                                mode="gauge+number",
                                value=_pos_pct,
                                number=dict(suffix="%", font=dict(color="#c62828", size=28)),
